...
- 本地导入 Markdown 文件夹，并按 `.md` 文件生成章节。
- 以 gallery 书籍卡片管理本地书稿，支持拖入文件夹或点击选择文件夹导入。
...
- 章节版本管理支持内容快照、版本别名、版本 Diff 和旧批注定位检查。
