...
- 阅读界面：多套主题系列、纸书感排版、可调字体、聚焦模式、全屏阅读和图片预览。
...
4. 进入阅读器后，可以阅读、搜索、批注、切换主题或进入全屏阅读。需要更快批注时，可在“主页 - 设置”中开启“划动批注”。
...
- 批注、高亮、评论和上下文
- 阅读进度
- 阅读器排版设置、主界面字体、阅读器字体、主题、快捷键、聚焦模式和划动批注开关
