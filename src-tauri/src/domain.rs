...
pub struct AppSettings {
    ...
    pub interface_latin_font_family: String,
    pub interface_cjk_font_family: String,
    pub reader_font_family: String,
    pub reader_latin_font_family: String,
...
pub struct SettingsPatch {
    ...
    pub interface_latin_font_family: Option<String>,
    pub interface_cjk_font_family: Option<String>,
    pub reader_font_family: Option<String>,
    pub reader_latin_font_family: Option<String>,
    pub reader_cjk_font_family: Option<String>,
    ...
    pub highlight_colors: Option<String>,
