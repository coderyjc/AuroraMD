...
export const defaultSettings: AppSettings = {
  ...
  themeSeries: "classic",
  theme: "paper",
  interfaceFontFamily: '"IBM Plex Sans", "Segoe UI", "Microsoft YaHei", sans-serif',
  interfaceLatinFontFamily: '"IBM Plex Sans", "Segoe UI", sans-serif',
  interfaceCjkFontFamily: '"Microsoft YaHei", "PingFang SC", "Noto Sans CJK SC", sans-serif',
  readerFontFamily: "Literata, Georgia, serif",
  readerLatinFontFamily: "Literata, Georgia, serif",
  readerCjkFontFamily: '"Noto Serif SC", "Songti SC", SimSun, serif',
  fontSize: 18,
  lineHeight: 1.72,
  contentWidth: 820,
  pagePadding: 52,
